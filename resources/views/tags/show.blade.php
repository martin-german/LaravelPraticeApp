...
<div class="container mx-auto px-4 py-8 text-white font-jakarta">
    <h1 class="text-2xl font-bold mb-6">{{ $tags->name }} részletek</h1>
    
    <div class="bg-[#1C2A29] p-6 rounded shadow-md">
        <h1 class="text-xl font-semibold mb-4">{{ $tags->name }}</h1>
        <h2 class="text-xs mb-4"> Cimke: {{ $tags->category->name }}</h2>
